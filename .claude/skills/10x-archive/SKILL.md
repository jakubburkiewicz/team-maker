...
5. **Zamknij pasujący element roadmapy.** Uruchom to przy **każdej** archiwizacji — wyszukiwanie roadmapy jest obowiązkowe. "Najlepszy wysiłek" dotyczy tylko *edycji*: brakująca roadmapa lub niezidentyfikowany cel edycji jest pomijany cicho i nigdy nie blokuje, nie wycofuje ani nie monituje archiwizacji. NIE oznacza to "założenia, że nie ma roadmapy i pominięcia sprawdzenia". Nie szukanie jest wadą — potwierdzenie (krok 7) musi zgłosić wynik w obu przypadkach.
