...
- [x] 4.1 Zero trafień na pełny zestaw obalonych fraz w całym pliku — 114a196
- [x] 4.2 Dokładnie jedna linia z `62a6f68`; trzy punkty ledgera datowane `2026-09-07` — 114a196
- [x] 4.3 §8 ma linię o ostatnim refreshu z commitem `62a6f68` — 114a196
- [x] 4.4 Liczba nagłówków `## ` = 8 — 114a196
...
- [x] 4.10 Przebieg czytelniczy §2 → §3 → §4 → §5 → §6 bez sprzeczności — 114a196
- [x] 4.11 Sześć ryzyk §2 to te same sześć, w tej samej kolejności, z tymi samymi ocenami — 114a196
- [x] 4.12 `/10x-plan` Fazy 1 może ruszyć — cztery komórki aktualne — 114a196
- [x] 4.13 Archiwum nietknięte, a przewodnik nie powtarza jego fałszywej tezy — 114a196
