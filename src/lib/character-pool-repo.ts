 ...
 *
 * Kształt wiersza jest opisany ręcznie: `supabase gen types` nie wchodzi do projektu (wymaga
 * zlinkowanego projektu albo Dockera i nie ma dziś drugiego konsumenta).
 */
...
/**
 * Czyste mapowanie wiersz → `PoolCharacter`. Zachowuje kolejność wierszy i perków — porządek
 * po `sort_order` nakłada zapytanie w `getCharacterPool`.
 */
 ...
 * awaria bazy, a wywołujący musi umieć je rozróżnić.
 */
